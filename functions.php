...
if ( ! function_exists( 'amenum_core_setup' ) ) :
	...
	function amenum_core_setup() {
		 ...
		 * If you're building a theme based on Amenum Core, use a find and replace
		 * to change 'amenum-core' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'amenum-core' ),
			)
		);
